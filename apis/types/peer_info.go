...
func (m *PeerInfo) validateCallSystem(formats strfmt.Registry) (err error) {
...
func (m *PeerInfo) MarshalBinary() (b []byte, err error) {
	if m == nil {
		return
	}
...
func (m *PeerInfo) UnmarshalBinary(b []byte) (err error) {
	var res PeerInfo
