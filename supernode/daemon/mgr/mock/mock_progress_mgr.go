...
func (m *MockProgressMgr) InitSlidingWindow(ctx context.Context, taskID string, windowSize int32) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "InitSlidingWindow", ctx, taskID, windowSize)
	ret0, _ := ret[0].(error)
	return ret0
}

// InitSlidingWindow indicates an expected call of InitSlidingWindow
func (mr *MockProgressMgrMockRecorder) InitSlidingWindow(ctx, taskID, windowSize interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "InitSlidingWindow", reflect.TypeOf((*MockProgressMgr)(nil).InitSlidingWindow), ctx, taskID, windowSize)
}
