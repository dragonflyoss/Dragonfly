...
func (cm *Manager) GetGCTaskIDs(ctx context.Context, taskMap *syncmap.SyncMap) ([]string, error) {
	...
	walkFn := func(path string, info os.FileInfo, err error) error {
		...
		if _, err := taskMap.Get(taskID); err == nil || !errortypes.IsDataNotFound(err) {
			if err != nil {
